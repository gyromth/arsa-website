...
export const translations = {
  en: {
    ...
    'hero.typewriter.1': 'move forward',
    'hero.typewriter.2': 'find people',
    'hero.typewriter.3': 'grow faster',
    ...
    'process.02.text': 'Markets, format, terms.',
  ...
  ru: {
    ...
    'hero.typewriter.1': 'бизнесу расти',
    'hero.typewriter.2': 'искать людей',
    'hero.typewriter.3': 'расти быстрее',
    ...
    'process.02.text': 'Рынки, формат, условия.',
